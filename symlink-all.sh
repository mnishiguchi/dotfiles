...
symlink_file "$SCRIPTPATH/memolist/templates/md.txt" "$HOME/Documents/memolist/templates/md.txt"
symlink_file "$SCRIPTPATH/ranger/rc.conf" "$HOME/.config/ranger/rc.conf"
